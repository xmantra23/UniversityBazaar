...
public class MyLoanItemListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(user != null){ //user is logged in.
            ...
            loans = loanDAO.getLoanByMemberId(user.getMemberId()); //get all the sales whose creatorId matches the logged in users memberId.
            adapter.setLoans(loans); //initialize the recycler view with the retrieved sales from the database.
        }
